...
#define camlidl_cudd_ml2c_bdd_bdd__dt(v,c,ctx) camlidl_cudd_node_ml2c(v,c)

#define camlidl_cudd_c2ml_bdd_bdd__dt(c,ctx) camlidl_cudd_bdd_c2ml(c)

#define camlidl_cudd_ml2c_bdd_bdd__vt(v,c,ctx) camlidl_cudd_node_ml2c(v,c)

#define camlidl_cudd_c2ml_bdd_bdd__vt(c,ctx) camlidl_cudd_bdd_c2ml(c)

#define camlidl_cudd_ml2c_bdd_bdd__t(v,c,ctx) camlidl_cudd_node_ml2c(v,c)

#define camlidl_cudd_c2ml_bdd_bdd__t(c,ctx) camlidl_cudd_bdd_c2ml(c)

value camlidl_cudd_bdd_manager(
	value _v_no)
{
  bdd__t no; /*in*/
  man__t _res;
  ...
  camlidl_cudd_ml2c_bdd_bdd__t(_v_no, &no, _ctx);
...
value camlidl_cudd_bdd_is_complement(
	value _v_no)
{
  bdd__t no; /*in*/
  int _res;
...
if (Cudd_IsComplement(no.node)) _res.node = Cudd_Not(_res.node);
  ...
  /* end user-supplied calling sequence */
  _vres = camlidl_cudd_c2ml_bdd_bdd__t(&_res, _ctx);
  camlidl_free(_ctx);
  return _vres;
}

value camlidl_cudd_bdd_delse(
	value _v_no)
{
  bdd__t no; /*in*/
  bdd__t _res;
...
value camlidl_cudd_bdd_cofactor(
	value _v_no1,
	value _v_no2)
{
  bdd__t no1; /*in*/
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_cudd_ml2c_bdd_bdd__t(_v_no1, &no1, _ctx);
  camlidl_cudd_ml2c_bdd_bdd__t(_v_no2, &no2, _ctx);
  /* begin user-supplied calling sequence */
...
value camlidl_cudd_bdd_support(
	value _v_no)
{
  bdd__t no; /*in*/
  bdd__t _res;
...
value camlidl_cudd_bdd_supportsize(
	value _v_no)
{
  bdd__t no; /*in*/
  int _res;
...
value camlidl_cudd_bdd_is_var_in(
	value _v_var,
	value _v_no)
{
  int var; /*in*/
...
value camlidl_cudd_bdd_support_inter(
	value _v_no1,
	value _v_no2)
{
  bdd__t no1; /*in*/
...
value camlidl_cudd_bdd_newvar_at_level(
	value _v_man,
	value _v_level)
{
  man__t man; /*in*/
...
value camlidl_cudd_bdd_is_true(
	value _v_no)
{
  bdd__t no; /*in*/
  int _res;
...
value camlidl_cudd_bdd_is_false(
	value _v_no)
{
  bdd__t no; /*in*/
  int _res;
...
value camlidl_cudd_bdd_is_equal(
	value _v_no1,
	value _v_no2)
{
  bdd__t no1; /*in*/
...
value camlidl_cudd_bdd_is_inter_empty(
	value _v_no1,
	value _v_no2)
{
  bdd__t no1; /*in*/
...
value camlidl_cudd_bdd_is_equal_when(
	value _v_no1,
	value _v_no2,
	value _v_no3)
{
  ...
  camlidl_cudd_ml2c_bdd_bdd__t(_v_no1, &no1, _ctx);
  camlidl_cudd_ml2c_bdd_bdd__t(_v_no2, &no2, _ctx);
  camlidl_cudd_ml2c_bdd_bdd__t(_v_no3, &no3, _ctx);
  /* begin user-supplied calling sequence */
...
value camlidl_cudd_bdd_is_leq_when(
	value _v_no1,
	value _v_no2,
	value _v_no3)
{
...
value camlidl_cudd_bdd_is_ite_cst(
	value _v_no1,
	value _v_no2,
	value _v_no3)
{
...
value camlidl_cudd_bdd_is_var_dependent(
	value _v_var,
	value _v_no)
{
  int var; /*in*/
...
value camlidl_cudd_bdd_is_var_essential(
	value _v_index,
	value _v_phase,
	value _v_no)
{
...
value camlidl_cudd_bdd_nbpaths(
	value _v_no)
{
  bdd__t no; /*in*/
  double _res;
...
value camlidl_cudd_bdd_nbtruepaths(
	value _v_no)
{
  bdd__t no; /*in*/
  double _res;
...
value camlidl_cudd_bdd_nbminterms(
	value _v_nvar,
	value _v_no)
{
  int nvar; /*in*/
...
value camlidl_cudd_bdd_density(
	value _v_nvar,
	value _v_no)
{
  int nvar; /*in*/
...
value camlidl_cudd_bdd_ite_cst(
	value _v_no1,
	value _v_no2,
	value _v_no3)
{
  ...
  if (_res == NULL) {
    ...
    _v1 = camlidl_cudd_c2ml_bdd_bdd__t(&*_res, _ctx);
    Begin_root(_v1)
      _vres = camlidl_alloc_small(1, 0);
      Field(_vres, 0) = _v1;
    End_roots();
...
value camlidl_cudd_bdd_compose(
	value _v_var,
	value _v_no1,
	value _v_no2)
{
...
value camlidl_cudd_bdd_intersect(
	value _v_no1,
	value _v_no2)
{
  bdd__t no1; /*in*/
...
value camlidl_cudd_bdd_existand(
	value _v_no1,
	value _v_no2,
	value _v_no3)
{
...
value camlidl_cudd_bdd_existxor(
	value _v_no1,
	value _v_no2,
	value _v_no3)
{
...
value camlidl_cudd_bdd_booleandiff(
	value _v_no,
	value _v_index)
{
  bdd__t no; /*in*/
...
value camlidl_cudd_bdd_cube_union(
	value _v_no1,
	value _v_no2)
{
  bdd__t no1; /*in*/
...
value camlidl_cudd_bdd_constrain(
	value _v_no1,
	value _v_no2)
{
  bdd__t no1; /*in*/
...
value camlidl_cudd_bdd_tdconstrain(
	value _v_no1,
	value _v_no2)
{
  bdd__t no1; /*in*/
...
value camlidl_cudd_bdd_restrict(
	value _v_no1,
	value _v_no2)
{
  bdd__t no1; /*in*/
...
value camlidl_cudd_bdd_tdrestrict(
	value _v_no1,
	value _v_no2)
{
  bdd__t no1; /*in*/
...
value camlidl_cudd_bdd_minimize(
	value _v_no1,
	value _v_no2)
{
  bdd__t no1; /*in*/
...
value camlidl_cudd_bdd_licompaction(
	value _v_no1,
	value _v_no2)
{
  bdd__t no1; /*in*/
...
value camlidl_cudd_bdd_squeeze(
	value _v_no1,
	value _v_no2)
{
  bdd__t no1; /*in*/
...
value camlidl_cudd_bdd_clippingand(
	value _v_no1,
	value _v_no2,
	value _v_maxdepth,
	value _v_direction)
...
value camlidl_cudd_bdd_clippingexistand(
	value _v_no1,
	value _v_no2,
	value _v_no3,
	value _v_maxdepth,
...
value camlidl_cudd_bdd_underapprox(
	value _v_nvars,
	value _v_threshold,
	value _v_safe,
	value _v_quality,
...
value camlidl_cudd_bdd_overapprox(
	value _v_nvars,
	value _v_threshold,
	value _v_safe,
	value _v_quality,
...
value camlidl_cudd_bdd_remapunderapprox(
	value _v_nvars,
	value _v_threshold,
	value _v_quality,
	value _v_no)
...
value camlidl_cudd_bdd_remapoverapprox(
	value _v_nvars,
	value _v_threshold,
	value _v_quality,
	value _v_no)
...
value camlidl_cudd_bdd_biasedunderapprox(
	value _v_nvars,
	value _v_threshold,
	value _v_quality1,
	value _v_quality0,
...
value camlidl_cudd_bdd_biasedunderapprox_bytecode(value * argv, int argn)
{
  return camlidl_cudd_bdd_biasedunderapprox(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5]);
}

value camlidl_cudd_bdd_biasedoverapprox(
	value _v_nvars,
	value _v_threshold,
	value _v_quality1,
	value _v_quality0,
...
value camlidl_cudd_bdd_biasedoverapprox_bytecode(value * argv, int argn)
{
  return camlidl_cudd_bdd_biasedoverapprox(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5]);
}

value camlidl_cudd_bdd_subsetcompress(
	value _v_nvars,
	value _v_threshold,
	value _v_no)
{
...
value camlidl_cudd_bdd_supersetcompress(
	value _v_nvars,
	value _v_threshold,
	value _v_no)
{
...
value camlidl_cudd_bdd_subsetHB(
	value _v_nvars,
	value _v_threshold,
	value _v_no)
{
...
value camlidl_cudd_bdd_supersetHB(
	value _v_nvars,
	value _v_threshold,
	value _v_no)
{
...
value camlidl_cudd_bdd_subsetSP(
	value _v_nvars,
	value _v_threshold,
	value _v_hardlimit,
	value _v_no)
...
value camlidl_cudd_bdd_supersetSP(
	value _v_nvars,
	value _v_threshold,
	value _v_hardlimit,
	value _v_no)
...
value camlidl_cudd_bdd_approxconjdecomp(value _v_no)
{
...
value camlidl_cudd_bdd_approxdisjdecomp(value _v_no)
{
  CAMLparam1(_v_no); CAMLlocal4(_v_res,_v_a,_v_b,_v_pair);
  bdd__t no;
  int res;
...
value camlidl_cudd_bdd_iterconjdecomp(value _v_no)
{
  CAMLparam1(_v_no); CAMLlocal4(_v_res,_v_a,_v_b,_v_pair);
  bdd__t no;
  int res;
...
value camlidl_cudd_bdd_iterdisjdecomp(value _v_no)
{
  CAMLparam1(_v_no); CAMLlocal4(_v_res,_v_a,_v_b,_v_pair);
  bdd__t no;
  int res;
...
value camlidl_cudd_bdd_genconjdecomp(value _v_no)
{
  CAMLparam1(_v_no); CAMLlocal4(_v_res,_v_a,_v_b,_v_pair);
  bdd__t no;
  int res;
...
value camlidl_cudd_bdd_gendisjdecomp(value _v_no)
{
  CAMLparam1(_v_no); CAMLlocal4(_v_res,_v_a,_v_b,_v_pair);
  bdd__t no;
  int res;
...
value camlidl_cudd_bdd_varconjdecomp(value _v_no)
{
  CAMLparam1(_v_no); CAMLlocal4(_v_res,_v_a,_v_b,_v_pair);
  bdd__t no;
  int res;
...
value camlidl_cudd_bdd_vardisjdecomp(value _v_no)
{
  CAMLparam1(_v_no); CAMLlocal4(_v_res,_v_a,_v_b,_v_pair);
  bdd__t no;
  int res;
...
value camlidl_cudd_bdd_transfer(
	value _v_no,
	value _v_man)
{
  bdd__t no; /*in*/
...
value camlidl_cudd_bdd_correlation(
	value _v_no1,
	value _v_no2)
{
  bdd__t no1; /*in*/
...
value camlidl_cudd_bdd_correlationweights(
	value _v_no1,
	value _v_no2,
	value _v_prob)
{
