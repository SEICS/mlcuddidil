...
int camlidl_cudd_transl_table_memo_enum_7[3] = {
  Global,
  Cache,
  Hash,
};

int camlidl_cudd_ml2c_memo_enum_memo_discr(value _v1)
{
  int _c2;
  _c2 = camlidl_cudd_transl_table_memo_enum_7[Int_val(_v1)];
  return _c2;
}

value camlidl_cudd_c2ml_memo_enum_memo_discr(int _c1)
{
  value _v2;
  switch(_c1) {
  ...
  default: caml_invalid_argument("enum memo_discr: bad enum memo_discr value");
  }
  return _v2;
}

int camlidl_cudd_ml2c_memo_union_memo_union(value _v1, union memo_union * _c2, camlidl_ctx _ctx)
{
  int _c3;
  value _v4;
  value _v5;
  ...
  if (Is_long(_v1)) {
    ...
    case 0: /* Cache */
      _c3 = Cache;
      _v4 = Field(_v1, 0);
      camlidl_cudd_ml2c_cache_cache__t(_v4, &(*_c2).cache, _ctx);
      break;
    case 1: /* Hash */
      _c3 = Hash;
      _v5 = Field(_v1, 0);
      camlidl_cudd_ml2c_hash_hash__t(_v5, &(*_c2).hash, _ctx);
      break;
    }
  }
  return _c3;
...
value camlidl_cudd_c2ml_memo_union_memo_union(int _discr1, union memo_union * _c2, camlidl_ctx _ctx)
{
  value _v3;
  value _v4;
  value _v5;
  ...
  case Global:
    ...
    break;
  case Cache:
    _v4 = camlidl_cudd_c2ml_cache_cache__t(&(*_c2).cache, _ctx);
    Begin_root(_v4)
    ...
    break;
  case Hash:
    _v5 = camlidl_cudd_c2ml_hash_hash__t(&(*_c2).hash, _ctx);
    Begin_root(_v5)
    ...
    break;
  default:
    caml_invalid_argument("union memo_union: bad discriminant for union memo_union");
  }
  return _v3;
}

void camlidl_cudd_ml2c_memo_struct_memo__t(value _v1, struct memo__t * _c2, camlidl_ctx _ctx)
{
  (*_c2).discr = camlidl_cudd_ml2c_memo_union_memo_union(_v1, &(*_c2).u, _ctx);
}

value camlidl_cudd_c2ml_memo_struct_memo__t(struct memo__t * _c1, camlidl_ctx _ctx)
{
  value _v2;
  _v2 = camlidl_cudd_c2ml_memo_union_memo_union((*_c1).discr, &(*_c1).u, _ctx);
  return _v2;
}
